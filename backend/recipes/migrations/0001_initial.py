# Generated by Django 4.2.8 on 2024-01-10 08:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cart_id', models.PositiveIntegerField(default=0, verbose_name='Номер списка')),
                ('count', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(limit_value=1), django.core.validators.MaxValueValidator(limit_value=1000)], verbose_name='Количество ингредиента')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('cart_id', 'ingredient'), name='unique_shopping_cart'),
        ),
        migrations.AddConstraint(
            model_name='ingredientsrecipes',
